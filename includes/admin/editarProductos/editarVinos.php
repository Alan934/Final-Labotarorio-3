...
<head>
    ...
    <title>Editar-Vinos-Barpincho</title>
...
<?php 
    ...
    if(isset($_POST['confirmar'])){
        ...
        $query = "UPDATE vinos set nombre = '$nombre', url = '$url', precio = '$precio', capacidad = '$capacidad', variedad = '$variedad' WHERE id = $id";
        mysqli_query($conex, $query);

        $_SESSION['mensajeAdmin'] = '!Editado Correctamente Vino¡';
...
<body class="bodyEditar">
    ...
    <main class="form-signin w-50 m-auto">
        <br><br><br><br>
        <form action="editarVinos.php?idVino=<?php echo $_GET['idVino']; ?>" method="POST">
            <h1 class="h3 mb-3 text-warning text-center fw-bold">EDITAR VINO</h1>
