...
<head>
    ...
    <title>Editar-Espumantes-Barpincho</title>
...
<?php 
    if(isset($_GET['idEspumantes'])){
        ...
        $query = "SELECT * FROM espumantes  WHERE id = $id";
    ...
    if(isset($_POST['confirmar'])){
        ...
        $query = "UPDATE espumantes set nombre = '$nombre', url = '$url', precio = '$precio', capacidad = '$capacidad' WHERE id = $id";
        mysqli_query($conex, $query);

        $_SESSION['mensajeAdmin'] = '!Editado Correctamente Espumante¡';
...
<body class="bodyEditar">
    ...
    <main class="form-signin w-50 m-auto">
        <br><br><br><br>
        <form action="editarEspumantes.php?idEspumantes=<?php echo $_GET['idEspumantes']; ?>" method="POST">
            <h1 class="h3 mb-3 text-warning text-center fw-bold">EDITAR Espumante</h1>
