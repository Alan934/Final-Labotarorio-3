...
<head>
    ...
    <title>Editar-Whiskys-Barpincho</title>
...
<?php 
    if(isset($_GET['idWhiskys'])){
        $id = $_GET['idWhiskys'];
        $query = "SELECT * FROM whiskys  WHERE id = $id";
    ...
    if(isset($_POST['confirmar'])){
        ...
        $query = "UPDATE whiskys set nombre = '$nombre', url = '$url', precio = '$precio', capacidad = '$capacidad' WHERE id = $id";
        mysqli_query($conex, $query);

        $_SESSION['mensajeAdmin'] = '!Editado Correctamente Whisky¡';
...
<body class="bodyEditar">
    ...
    <main class="form-signin w-50 m-auto">
        <br><br><br><br>
        <form action="editarWhiskys.php?idWhiskys=<?php echo $_GET['idWhiskys']; ?>" method="POST">
            <h1 class="h3 mb-3 text-warning text-center fw-bold">EDITAR Whisky</h1>
